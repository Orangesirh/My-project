...
class ISGNet(nn.Module):
    def __init__(self,
        ...
        print("\n" + "="*60)
        print("ISGNet Fusion Configuration (Single Iteration Mode):")
        ...
        for idx, s in enumerate(reassemble_s):
            ...
            self.fusions.append(Fusion(
                ...
                use_msda=use_msda_current,
                msda_dilation=msda_dilation
            ))
    ...
    def forward(self, img):
        ...
        输出:
            out_depths: 多尺度深度预测列表 [1个iteration][4个尺度]
            out_segs: 多尺度分割预测列表 [1个iteration][4个尺度]
        """
        # Transformer编码
